...
class CartPage extends StatelessWidget {
  Widget generateCart(BuildContext context, Menu d) {
    return Padding(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: NetworkImage(d.data[0].image),
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: <Widget>[
                        ...
                        child: InkResponse(
                          onTap: () {
                            Get.find<HomePageController>()
                                .removeFromCart(d.data[0].idTable ?? 0);
                  ...
                  Text('Price ₸{d.data[0].price.toString()}'),
                ],
              ),
            ))
          ],
